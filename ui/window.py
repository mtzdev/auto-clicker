...
"}")
        ...
        self.bindMouseButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.BindMLineEdit.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.leftModeButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.rightModeButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
...
"}")
        ...
        self.cpsKBSpin.setEnabled(True)
        ...
        self.cpsKBLabel.setEnabled(True)
        ...
        self.keybindKBLabel.setEnabled(True)
        ...
        self.modeKBLabel.setEnabled(True)
        ...
        self.clickBindButton.setEnabled(True)
        ...
        self.clickBindButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
